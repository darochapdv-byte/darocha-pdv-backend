...
functions.post('/:name', async (c) => {
  ...
  'catalog-data','catalog-checkout','catalog-store-status','catalog-receipt','catalog-history','catalog-account-register','catalog-account-login','catalog-account-update','catalog-expire-pickups','mercadopago-connect','mercadopago-oauth-callback','mercadopago-status','mercadopago-disconnect','catalog-mp-status','catalog-checkout-pix','catalog-checkout-card','catalog-checkout-status','mercadopago-webhook','mp-point-devices','mp-point-charge','mp-point-status','mp-point-cancel','pdv-pix-create','pdv-pix-status','melhorenvio-status','melhorenvio-save-origin','melhorenvio-connect','melhorenvio-oauth-callback','melhorenvio-disconnect','shipping-calculate',
